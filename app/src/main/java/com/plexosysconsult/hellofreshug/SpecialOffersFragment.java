 ...
 */
public class SpecialOffersFragment extends Fragment implements View.OnClickListener{

    RecyclerView recyclerView;
    View v;
    String URL_GET_FRUITS = "http://www.gari-share.com/example/getAllSpecialOffers.php";
    ...
    Button bReload;
    TextView tvErrorMsg;
    String jsonFileName = "specialoffers.json";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_special_offers, container, false);
    ...
    private void putJsonIntoList(JSONObject jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < fruits.length(); i++) {
                ...
                fruit.setDescription(fruitJSON.getString("description"));
        ...
        recyclerView.setAdapter(new RecyclerViewAdapterSpecialOffer(getActivity(), fruitsToShow));
